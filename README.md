# hyperdht-prometheus-docker
Build and publish container for hyperdht-prometheus

```
docker run --network host --env HYPERDHT_PROM_SHARED_SECRET=<A 64 character hex string> --mount type=bind,source=/etc/prometheus/config/prometheus-dht-targets,destination=/home/hyperdht-prometheus/prometheus ghcr.io/holepunchto/hyperdht-prometheus-docker
```
